    ...
    <Provider store={store}>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/hot-deals/product/:productId"
            element={<MainContainer />}
          />
          <Route
            path="/hot-deals/recommendation"
            element={<RecommendationHotDealsContainer />}
          />
          <Route
            path="/hot-deals/return"
            element={<ReturnHotDealsContainer />}
          />
          <Route
            path="/products/ranking"
            element={<HotDealsRankingContainer />}
          />
          <Route path="/login" element={<LoginContainer />} />
          <Route path="/favorite" element={<MyFavoriteContainer />} />
          <Route
            path={"/oauth/callback/kakao"}
            element={<KaKaoOauthCallbackContainer />}
          />
          <Route path="/recommendation" element={<RecommendationContainer />} />
          <Route path="/notifications" element={<NotificationContainer />} />

          <Route
            path="/hoon/recommendation"
            element={<ManageRecommendationContainer />}
          />
          <Route path="/hoon/980320" element={<HotDealClassifyContainer />} />
          <Route
            path="/hoon/980320/product-classify"
            element={<ProductClassifyContainer />}
          />
          <Route
            path="/hoon/980320/manage"
            element={<ManageHotDealsContainer />}
          />
          <Route
            path="/hoon/980320/manage/return"
            element={<ManageReturnHotDealsContainer />}
          />
